#!/usr/bin/env python3
"""Fail-closed all-layer, road-width-aware audit for V4's 2-mm through IDs."""
...
STEPS = {
    "A_R1_full_native_rail_X_to_print_Z": ROOT / "work/quartet-team/geometry/profile-v4/generated/A_R1_full_native_rail.step",
    "B_R2_full_native_rail_X_to_print_Z": ROOT / "work/quartet-team/geometry/profile-v4/generated/B_R2_full_native_rail.step",
    "C_R2_full_rail_plus_1mm_seat_relief_X_to_print_Z": ROOT / "work/quartet-team/geometry/profile-v4/generated/C_R2_full_rail_plus_1mm_seat_relief.step",
}
ID_STARTS = {
    "A_R1_full_native_rail_X_to_print_Z": [-5.0],
    "B_R2_full_native_rail_X_to_print_Z": [-5.0, -1.0],
    "C_R2_full_rail_plus_1mm_seat_relief_X_to_print_Z": [-5.0, -1.0, 3.0],
}
...
def preview(records, layer_roads, output: Path) -> None:
    ...
    draw.text((24, 20), "V4 actual Orca deposited-coordinate ID through-hole audit", fill="#17364b", font=font)
...
def main() -> None:
    ...
    records = expected_holes(lower_bounds); all_pass = True; preview_roads = {}
    for record in records:
        ...
        assert len(report_layers) == 120, f"{record['object']}: expected 120 model layers, got {len(report_layers)}"
