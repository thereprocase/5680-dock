"""Package a verified native Orca candidate as a standalone folder and ZIP."""
...
def main():
    ...
    assert len(identifier['objects'])==6 and all(o['all_layer_count']==120 and o['all_layers_pass'] for o in identifier['objects'])
    out = args.out
    out.mkdir(parents=True)
    shutil.copy2(args.readme,out/'README.md')
    shutil.copy2(gcode,out/'A-B-C-handheld-coupons-P1S-0.4-PETG.gcode')
    title = 'V4 FULL RAIL A B C FIT COUPONS - ONE EACH'
