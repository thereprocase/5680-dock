...
stl = R/f'D8-R4-{VARIANT}{TAG}-quick-fit-bracket-print-TWO.stl'
step = R/f'D8-R4-{VARIANT}{TAG}-quick-fit-bracket.step'
...
canvas.save(R/f'D8-R4-{VARIANT}{TAG}-quick-fit.png')
im,_=render([(s,(62,117,139))],(1100,900),(1,-.15,.13),pad=60)
im.save(R/f'D8-R4-{VARIANT}{TAG}-quick-fit-profile.png')
