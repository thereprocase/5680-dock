...
def add_hinge_hardware(p,add):
    ...
    # This short nose transmits compression to the spring island. Keep its
    # bore smooth: the separate 8 mm nut body supplies thread engagement, and
    # a one-turn thread in a 2 mm nose is both fragile and kernel-sensitive.
