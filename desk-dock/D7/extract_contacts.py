...
data={'source_url':'https://content.hmxmedia.com/precision-16-5680-laptop-AR/gltf/precision-16-5680-laptop-AR.glb','source_sha256':hashlib.sha256(source.read_bytes()).hexdigest(),'case_node':'Dell4649','feet_node':'Dell4604','datum':'X preserving source handedness; Y about closed-envelope midplane; Z from rear-case datum. Build adds seat height, applies lean without reflection.','curves':curves,'rubber_feet':footboxes,'keepout_expansion_mm':2,'limits':'Visualization mesh, not manufacturing tolerances. Five side sections establish the sculpted seat envelope; replaceable liners absorb residual fit. Lid envelope retains published thickness.'}
